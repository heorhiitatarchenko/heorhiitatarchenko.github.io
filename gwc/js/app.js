(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".our-services-home__slider")) new core(".our-services-home__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                speed: 800,
                navigation: {
                    prevEl: ".our-services-home__prev",
                    nextEl: ".our-services-home__next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        function headerTitleClick(e) {
            if (document.querySelector(".header").classList.contains("_active") && !e.target.parentElement.parentElement.classList.contains("_active")) {
                document.querySelector(".spollers-menu._active").classList.remove("_active");
                e.target.parentElement.parentElement.classList.add("_active");
            } else if (document.querySelector(".header").classList.contains("_active") && e.target.parentElement.parentElement.classList.contains("_active")) {
                document.querySelector(".header").classList.remove("_active");
                e.target.parentElement.parentElement.classList.remove("_active");
            } else {
                document.querySelector(".header").classList.add("_active");
                e.target.parentElement.parentElement.classList.add("_active");
            }
        }
        function headerMedia(e) {
            const spollersMenu = document.querySelectorAll(".spollers-menu");
            const spollersTitles = document.querySelectorAll(".spollers-menu__title");
            if (e.matches) {
                spollersMenu.forEach((spoller => {
                    spoller.removeEventListener("mouseenter", headerMouseEnter);
                    spoller.removeEventListener("mouseleave", headerMouseLeave);
                }));
                spollersTitles.forEach((title => {
                    title.removeEventListener("click", headerTitleClick);
                }));
            } else {
                spollersMenu.forEach((spoller => {
                    spoller.addEventListener("mouseenter", headerMouseEnter);
                    spoller.addEventListener("mouseleave", headerMouseLeave);
                }));
                spollersTitles.forEach((title => {
                    title.addEventListener("click", headerTitleClick);
                }));
            }
        }
        const headerMediaQuery = window.matchMedia("(max-width: 991.98px)");
        headerMediaQuery.addListener(headerMedia);
        headerMedia(headerMediaQuery);
