 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            let thumbsGallery, mainGallery;
            if (document.querySelector(".gallery-home__thumbs-slider")) thumbsGallery = new core(".gallery-home__thumbs-slider", {
                modules: [ Grid ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".gallery-home__main-slider")) mainGallery = new core(".gallery-home__main-slider", {
