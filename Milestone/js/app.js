    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".main-home__slider")) {
                ...
                mainHomeSlider = new core(".main-home__slider", {
                    ...
                    on: {
                        init: () => {
                            const darkImages = document.querySelectorAll(".main-home__slide._dark-img");
                            darkImages.forEach((img => {
                                darkIndexes.push(Number(img.dataset.slideIndex));
                            }));
                        },
                        slideChange: () => {
                            console.log(mainHomeSlider.activeIndex);
                            console.log(darkIndexes);
                            console.log(darkIndexes.includes(mainHomeSlider.activeIndex));
                            if (darkIndexes.includes(mainHomeSlider.activeIndex)) document.querySelector(".header").classList.add("_header-white"); else if (document.querySelector(".header").classList.contains("_header-white")) document.querySelector(".header").classList.remove("_header-white");
                        }
                    }
                });
                insertBullets(document.querySelector(".main-home__slider"));
            }
            function slidersOnMobile(e) {
                if (e.matches) {
                    if (document.querySelector(".numbers-partner-home__slider")) {
                        numbersPartnerHomeSlider = new core(".numbers-partner-home__slider", {
                            modules: [ Pagination ],
                            observer: true,
                            observeParents: true,
                            slidesPerView: 1,
                            ...
                            preloadImages: false,
                            pagination: {
                                el: ".numbers-partner-home__pagination",
                                clickable: true
                            },
                            on: {}
                        });
                        insertBullets(document.querySelector(".numbers-partner-home__slider"));
                    }
                } else if (!e.matches) if (numbersPartnerHomeSlider) numbersPartnerHomeSlider.destroy(false);
            }
            mediaQuery.addListener(slidersOnMobile);
            slidersOnMobile(mediaQuery);
        }
        function insertBullets(el) {
            el.querySelectorAll("._slider-pagination .swiper-pagination-bullet").forEach((bullet => {
                bullet.innerHTML = `\n  <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">\n    <path d="M1.43788 3.7888L7.00006 0.577472L12.5622 3.7888V10.2114L7.00006 13.4228L1.43788 10.2114V3.7888Z" stroke="#7A1120"/>\n  </svg>\n  `;
            }));
        }
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            document.querySelectorAll("[data-src],[data-srcset]").forEach((el => {
                el.classList.add("_lazy-load");
            }));
            document.querySelectorAll("[data-bg]").forEach((el => {
                el.classList.add("_lazy-load-bg");
            }));
        }));
        class ScrollWatcher {
            constructor(props) {
        ...
        da.init();
        document.addEventListener("DOMContentLoaded", (() => {
            if (document.querySelector(".menu__item_dropdown")) {
                const langSelect = document.querySelector(".menu__item_dropdown .dropdown");
                document.addEventListener("click", langSelectFunc);
                function langSelectFunc(e) {
                    if (e.target.closest(".menu__item_dropdown")) langSelect.classList.toggle("_active"); else if (langSelect.classList.contains("_active")) langSelect.classList.remove("_active");
                }
            }
        }));
        window["FLS"] = false;
